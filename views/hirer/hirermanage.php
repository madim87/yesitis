        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-xs-12">
                    ...
                    <a  href="<?=Url::to(['vacancy/vacancyadd'])?>">Добавить вакансию</a>
                </div>
                ...
                foreach ($models as $model) {
                    ...
                    <!-- Job item -->
                    <div class="col-xs-12">
                        <a class="item-block" href="<?=Url::to(['vacancy/vacancy','id' => $model->id])?>">
                            <header>
                            ...
                            <a class="btn btn-xs btn-gray" href="<?=yii\helpers\Url::to(['vacancy/vacancyedit','id'=>$model->id])?>">Edit</a>
